...
export interface TestSourceTypeLookup {
  ...
  Storybook: NexusGenObjects['Storybook'],
  StorybookFile: NexusGenObjects['StorybookFile'],
  StorybookHtmlFile: NexusGenObjects['StorybookHtmlFile'],
  StorybookMainJs: NexusGenObjects['StorybookMainJs'],
